...
describe('useClickOutside Hook', () => {
    const TestComponent = ({ onClickOutside, events }: { onClickOutside: () => void, events?: ('mousedown' | 'mouseup' | 'touchstart' | 'touchend')[] }) => {
    ...
    it('should call handler when clicking outside with custom events', () => {
        ...
        const { getByTestId } = render(
            <TestComponent onClickOutside={handleClickOutside} events={['mouseup']} />
        );
